...
/*###############################################################################
# Nombre del Programa :  INIFiles.java                                          #
...
public final class INIFile {
  ...
  public static void main(String[] pstrArgs) {
    ...
    objINI = new INIFile("FieldPositions.ini");
    if (objINI.checkFile("FieldPositions.ini")) {
      System.out.println("HOLA !!!");
    }
    String sectionNames[] = objINI.getAllSectionNames();
    for (int i = 0; i < sectionNames.length; i++) {
      System.out.println(sectionNames[i]);
    }
    System.out.println(objINI.getStringProperty("Chedraui", "CODIGOBARRAS"));
...
//
  ...
  private class INISection {
    ...
    public void setProperty(String pstrProp, String pstrValue,
                            String pstrComments) {
      this.mhmapProps.put(pstrProp,
                          new INIProperty(pstrProp, pstrValue, pstrComments));
    }
