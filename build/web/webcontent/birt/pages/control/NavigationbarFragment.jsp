			...
			<TABLE CELLSPACING="0" CELLPADDING="0" WIDTH="100%" HEIGHT="25px" CLASS="birtviewer_navbar">
				...
				<TR>
					...
					<TD>
						...
						%>
							<%= 
								BirtResources.getMessage( "Mostrando Pagina" )
							%>&nbsp;
							<SPAN ID='pageNumber'></SPAN>&nbsp;
							<%= BirtResources.getMessage( "de" )%>&nbsp;
					...
					<TD ALIGN="right" WIDTH="80px"><LABEL for="gotoPage"><b><%= BirtResources.getMessage( "Ir a la Pagina:" )%></b></LABEL></TD>
					<TD WIDTH="2px"/>
